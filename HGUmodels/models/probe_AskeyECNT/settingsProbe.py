...
class HGU_AskeyECNT_settingsProbe(HGU_AskeyECNT):
    ...
    def checkIPv6Telefonica_43(self, dados):
        try:
            # GET
            dados_gpv = {'GPV_Param': {'parameterNames': [
                "InternetGatewayDevice.X_VIVO_COM_BR_IPv6Forwarding.IPv6Forwarding.1.Enable",
            ]}}
            dados.update(dados_gpv)
            dados_entrada = dados
            gpv_get = utils.ACS.getParameterValues(**dados_entrada)
    ...
    def accessWizard_401(self, flask_username):
        try:
            ...
            self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/a').click()
            time.sleep(2)
            self._driver.find_element_by_xpath(
                '//*[@id="accordion"]/li[2]/ul/li[2]/a').click()
            time.sleep(2)
            self._driver.find_element_by_xpath(
                '//*[@id="menu-loc-net"]/ul/li[1]/a').click()
            self._driver.quit()
    ...
    def accessRemoteHttp_405(self, flask_username):
        ...
        try:
            ...
            trustDomain = self._driver.find_element_by_xpath(
                '/html/body/div[5]/div/fieldset/div[1]/a[3]').click()
            trustDomain = self._driver.find_element_by_xpath(
                '/html/body/div[5]/div/fieldset/div[1]/a[3]').text
            time.sleep(1)
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')

            trustDomain_ip_valor = self._driver.find_element_by_xpath(
                '//*[@id="wan_src_ip"]').get_attribute('value')
            trustDomain_httpServices_port_valor = self._driver.find_element_by_xpath(
                '//*[@id="TrustDomainForm"]/div[2]/input[4]').get_attribute('value')
            trustDomain_SSHServices_port_valor = self._driver.find_element_by_xpath(
                '//*[@id="TrustDomainForm"]/div[3]/input[4]').get_attribute('value')
            ...
            for domain in dict_domain.values():
                for input in self._driver.find_elements_by_xpath(domain.xpath):
                    ...
                    domain.inputs.append(
                        'Habilitado' if teste == 'true' else 'Desabilitado')
            json_saida405 = {
                trustDomain:
                    {
            ...
            if json_saida405['Trust Domain']['httpServices'].get('WAN') == 'Desabilitado':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", 'result': 'passed', 'obs': 'WAN esta Desabilitado'})
            else:
            ...
            self.update_global_result_memory(
                flask_username, 'accessRemoteHttp_405', json_saida405)
            return self._dict_result
    ...
    def accessRemoteTrustedIP_408(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if ip == '':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", 'result': 'passed', 'obs': 'IP Address esta vazio'})
            else:
    ...
    def NTPServer_409(self):
        try:
            ...
            ssh.connect(hostname=self._address_ip, username=self._username,
                        password=self._password, timeout=2)
    ...
    def checkACSSettings_411(self, flask_username):
        ...
        try:
            ...
            self._driver.switch_to.frame('menuFrm')
            self._driver.find_element_by_xpath(
                '/html/body/div[5]/div/fieldset/div[1]/a[1]').click()
            self._driver.find_element_by_xpath(
                '/html/body/div[5]/div/fieldset/div[1]/a[1]').text
            ...
            tr69_cwmp_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[1]/input[1]').get_attribute('checked')
            tr69_cwmp_valor = 'Habilitado' if tr69_cwmp_valor == 'true' else 'Desabilitado'

            tr69_acsURL_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[2]/input').get_attribute('value')

            tr69_acsUsername_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[3]/input').get_attribute('value')

            tr69_acsPassword_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[4]/input').get_attribute('value')

            tr69_acsPII_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[5]/input').get_attribute('value')

            tr69_acsPII_interval_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/div[6]/input').get_attribute('value')

            tr69_connection_request_URL_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/fieldset/div[1]/label[2]').get_attribute('value')

            tr69_connection_request_Username_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/fieldset/div[2]/input').get_attribute('value')

            tr69_connection_request_Password_valor = self._driver.find_element_by_xpath(
                '/html/body/div/fieldset/form/fieldset/div[3]/input').get_attribute('value')
            json_saida411 = {
                "tr69_setting":
                    {
            ...
            if acs_url == 'http://acs.telesp.net.br:7005/cwmpWeb/WGCPEMgt':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", 'result': 'passed', "obs": "ACS URL esta correta"})
            else:
                self._dict_result.update(
                    {"obs": f'ACS URL incorreta, seu retorno: {acs_url}'})
    ...
    def validarDefaultUserACS_412(self, flask_username):
        ...
        if len(result) == 0:
            ...
            value = result['tr69_connection_request'].get(
                'tr69_connection_request_Username')
            if value == 'acsclient':
                self._dict_result.update(
                    {"obs": "Username esta correto", "result": 'passed'})
            else:
                self._dict_result.update(
    ...
    def validarDefaultPasswordACS_413(self, flask_username):
        ...
        if len(result) == 0:
            self._dict_result.update(
                {"obs": 'Execute o teste 411 primeiro', "result": 'failed'})
        else:
            value = result['tr69_setting'].get('tr69_acsPassword')
            if value == 'telefonica':
                self._dict_result.update(
                    {"obs": "Password esta correta", "result": 'passed', "Resultado_Probe": "OK"})
            else:
                self._dict_result.update(
    ...
    def periodicInformEnable_415(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if value == '1':
                self._dict_result.update(
                    {"obs": "Periodic Infom esta habilitado", "result": 'passed', "Resultado_Probe": "OK"})
            else:
                self._dict_result.update(
    ...
    def periodicInformInterval_416(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if value == '68400':
                self._dict_result.update(
                    {"obs": "Periodic Inform Interval OK", "result": 'passed', "Resultado_Probe": "OK"})
            else:
                self._dict_result.update(
    ...
    def connectionRequestPort_417(self, serialnumber, GPV_Param, IPACS, acsUsername, acsPassword):
        d = self.GPV_OneObjct_414(
            serialnumber, GPV_Param, IPACS, acsUsername, acsPassword)
        ...
        if gpv_probe == 'OK':
            ...
            for key in gpv_result:
                ...
                if port_cr_value == '7547':
                    self._dict_result.update(
                        {"obs": None, "result": 'passed', "Resultado_Probe": "OK"})
                    return self._dict_result
            self._dict_result.update(
                {"obs": "port_cr_value != '7547'", "result": 'failed'})
            return self._dict_result
        elif gpv_probe == 'NOK':
            self._dict_result.update(
    ...
    def enableCwmp_418(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if value == 'Habilitado':
                self._dict_result.update(
                    {"obs": "CWMP esta habilitado", "result": 'passed', "Resultado_Probe": "OK"})
            else:
    ...
    def userConnectionRequest_419(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if value == 'userid':
                self._dict_result.update(
                    {"obs": "Connection Request Username OK", "result": 'passed', "Resultado_Probe": "OK"})
            else:
                self._dict_result.update(
    ...
    def checkWanInterface_420(self, flask_username):
        ...
        try:
            ...
            self.login_support()
            self._driver.switch_to.frame('menuFrm')
            wanInterface = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[2]/a').click()
            time.sleep(1)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')

            header_list = [header.text for header in self._driver.find_elements_by_xpath(
                '//*[@id="WanIPIntfList"]/table/thead/tr/th')]
            number_cols = len(header_list)

            table_flat = self._driver.find_elements_by_xpath(
                '//*[@id="WanIPIntfList"]/table/tbody/tr/td')
            ...
            for k, item in dict_saida420.items():
                ...
                if item['Type'] == 'PPPoE' and item['VLAN'] == '10' and cpe_config['REDE'] == 'VIVO_1':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": "Type: PPPoE | VLAN: 10", "result": "passed"})
                    break
            else:
                self._dict_result.update(
                    {"obs": f"Teste incorreto, retorno: Type:{item['Type']}, VLAN:{item['VLAN']}, REDE:{cpe_config['REDE']}"})
            ...
            for _, sub_dict in result.items():
                ...
                if iface_type == 'PPPoE' and cpe_config['ACCESS'] == 'FIBER' and cpe_config['TYPE'] == 'FIBER':
                    if sub_dict.get('Priority') == '0':
                        self._dict_result.update(
                            {"obs": 'Type: PPPoE | Priority: 0', "result": 'passed', "Resultado_Probe": "OK"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno: Type:{iface_type}, Priority:{sub_dict.get('Priority')}"})
                        break
            else:
                self._dict_result.update(
            ...
            for _, sub_dict in result.items():
                ...
                if iface_type == '10' and cpe_config['ACCESS'] == 'FIBER' and cpe_config['TYPE'] == 'FIBER':
                    if sub_dict.get('Type') == 'PPPoE':
                        self._dict_result.update(
                            {"obs": 'VLAN: 10 | Type:PPPoE, teste OK', "result": 'passed', "Resultado_Probe": "OK"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno: VLAN:{iface_type}, TYPE:{sub_dict.get('Type')}"})
                        break
            else:
                self._dict_result.update(
    ...
    def checkNatSettings_423(self, flask_username):
        ...
        try:
            ...
            self._driver.switch_to.frame('menuFrm')
            wanInterface = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[3]/div[3]/a[1]').click()
            time.sleep(1)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            ...
            header_list = [header.text for header in self._driver.find_elements_by_xpath(
                '//*[@id="NATTable"]/table/thead/tr/th')]
            number_cols = len(header_list)
            table_flat = self._driver.find_elements_by_xpath(
                '//*[@id="NATTable"]/table/tbody/tr/td')
            checkbox_inputs = self._driver.find_elements_by_xpath(
                '//*[@id="NATTable"]/table/tbody/tr/td/input')
            ...
            for i, row in dict_saida423.items():
                ...
                if row['Interface'] == 'ip2' and cpe_config['ACCESS'] == 'FIBER' and cpe_config['TYPE'] == 'FIBER':
                    if row['Adm.State'] == 'Habilitado':
                        self._dict_result.update(
                            {"Resultado_Probe": "OK", "obs": "Interface: Ip2 | Adm.State: Habilitado", "result": "passed"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": "Interface: Ip2 | Adm.State: desabilitado"})
                        break
                else:
                    self._dict_result.update(
                        {"obs": f"Interface Ip2 nao existe, , ACCESS:{cpe_config['ACCESS']} TYPE:{cpe_config['TYPE']}"})
            self._driver.quit()
    ...
    def checkMulticastSettings_424(self, flask_username):
        ...
        try:
            ...
            self._driver.switch_to.frame('menuFrm')
            self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[5]/a[1]').click()
            time.sleep(1)
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')

            header_list = [header.text for header in self._driver.find_elements_by_xpath(
                '//*[@id="MulticastTable"]/table/thead/tr/th')]
            number_cols = len(header_list)
            table_flat = self._driver.find_elements_by_xpath(
                '//*[@id="MulticastTable"]/table/tbody/tr/td')
            checkbox_inputs = self._driver.find_elements_by_xpath(
                '//*[@id="MulticastTable"]/table/tbody/tr/td/input')
            table = chunks(table_flat, number_cols)
            dict_saida424 = {}
            for i, row in enumerate(table):
                d = {col: (('Habilitado' if checkbox_inputs[i].get_attribute('checked') == 'true' else 'Desabilitado') if j == 1 else
            ...
            for _, row in dict_saida424.items():
                if row['Interface'] == 'ip2':
                    if row['IGMP'] == 'Desabilitado':
                        self._dict_result.update(
                            {"Resultado_Probe": "OK", "obs": "Interface: ip2 | IGMP: Desabilitado", "result": "passed"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": "Interface: ip2 | IGMP: Habilitado"})
                        break
                else:
                    self._dict_result.update(
                        {"obs": "Interface Ip2 nao existe"})
    ...
    def getFullConfig_425(self, flask_username):
        ...
        gpon = self._driver.find_element_by_xpath(
            '//*[@id="status"]/tbody/tr[1]/th/span').text
        ...
        internet = self._driver.find_element_by_xpath(
            '//*[@id="status"]/tbody/tr[3]/th/span').text
        print(internet)
        ...
        detalhes_IPv4 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[4]/td[2]/div[2]/div[1]')
        time.sleep(1)
        ...
        detalhes_IPv4 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[4]/td[2]/div[2]/div[2]')
        ...
        detalhes_IPv6 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[4]/td[2]/div[3]/div[1]')
        time.sleep(1)
        ...
        detalhes_IPv6 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[4]/td[2]/div[3]/div[2]')
        items_key = detalhes_IPv6.find_elements_by_tag_name("li")
        detalhes_IPv6_valor = []
        for item in items_key:
            teste = item.text
        ...
        wifi_24_detalhes_stations = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[6]/td[2]/textarea').get_attribute('value')
        ...
        wifi_5 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[7]/th/span').text
        print(wifi_5)
        wifi_5_name = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[7]/td[1]/div').text
        wifi_5_name = wifi_5_name.replace('\n', ' ').split(' ')
        print(wifi_5_name)
        wifi_5_detalhes = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[7]/td[2]/a')
        wifi_5_detalhes.click()
        wifi_5_detalhes_info = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[8]/td[1]/div')
        ...
        wifi_5_detalhes_stations = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[8]/td[2]/textarea').get_attribute('value')
        ...
        rede_local = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[9]/th/span').text
        print(rede_local)
        time.sleep(2)
        rede_local_name = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[9]/td[1]').text
        ...
        rede_local_detalhes = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[9]/td[2]/a')
        rede_local_detalhes.click()
        rede_local_stations = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[10]/td[2]/textarea').get_attribute('value')
        ...
        tv = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[11]/th/span').text
        print(tv)
        tv_detalhes = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[11]/td[2]/a').click()
        tv_info = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[12]/td[1]/div')
        ...
        tv_stations = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[12]/td[2]/textarea').get_attribute('value')
        ...
        telefone = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[13]/th/span').text
        print(telefone)
        telefone_info_rede = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[13]/td[1]/div[1]').text
        ...
        telefone_info_status = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[13]/td[1]/div[2]').text
        telefone_info_status = telefone_info_status.split('\n')
        print(telefone_info_status)
        telefone_detalhes = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[11]/td[2]/a').click()
        telefone_stations = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[14]/td[2]/textarea').get_attribute('value')
        ...
        config_internet = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[1]/a')
        config_internet.click()
        config_internet = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[1]/a').text
        print(config_internet)
        config_internet_usuario = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[2]/td[1]').text
        print(config_internet_usuario)
        config_internet_usuario_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[2]/td[2]/input').get_property('value')
        print(config_internet_usuario_valor)
        config_internet_senha = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[3]/td[1]').text
        print(config_internet_senha)
        config_internet_senha_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[3]/td[2]/input').get_property('value')
        ...
        connfig_redelocal = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[2]/a').text
        print(config_redelocal)
        config_redelocal_dhcp = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/thead/tr/th').text
        print(config_redelocal_dhcp)
        config_redelocal_servidordhcp = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[2]/td[1]').text
        print(config_redelocal_servidordhcp)
        config_redelocal_servidordhcp_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[2]/td[2]/input[1]').get_attribute('checked')
        ...
        config_redelocal_iphgu = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[3]/td[1]').text
        print(config_redelocal_iphgu)
        config_redelocal_iphgu_valor01 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[3]/td[2]/input[1]').get_property('value')
        config_redelocal_iphgu_valor02 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[3]/td[2]/input[2]').get_property('value')
        config_redelocal_iphgu_valor03 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[3]/td[2]/input[3]').get_property('value')
        config_redelocal_iphgu_valor04 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[3]/td[2]/input[4]').get_property('value')
        ...
        config_redelocal_mask = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[4]/td[1]').text
        print(config_redelocal_mask)
        config_redelocal_mask_valor01 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[4]/td[2]/input[1]').get_property('value')
        config_redelocal_mask_valor02 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[4]/td[2]/input[2]').get_property('value')
        config_redelocal_mask_valor03 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[4]/td[2]/input[3]').get_property('value')
        config_redelocal_mask_valor04 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[4]/td[2]/input[4]').get_property('value')
        ...
        config_redelocal_pool = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[5]/td[1]').text
        print(config_redelocal_pool)
        config_redelocal_pool_valor_ini01 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[5]/td[2]/input[1]').get_property('value')
        config_redelocal_pool_valor_ini02 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[5]/td[2]/input[2]').get_property('value')
        config_redelocal_pool_valor_ini03 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[5]/td[2]/input[3]').get_property('value')
        config_redelocal_pool_valor_ini04 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[5]/td[2]/input[4]').get_property('value')
        ...
        config_redelocal_pool_valor_fin01 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[6]/td/input[1]').get_property('value')
        config_redelocal_pool_valor_fin02 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[6]/td/input[2]').get_property('value')
        config_redelocal_pool_valor_fin03 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[6]/td/input[3]').get_property('value')
        config_redelocal_pool_valor_fin04 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[6]/td/input[4]').get_property('value')
        ...
        config_redelocal_dns = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[7]/td[1]').text
        print(config_redelocal_dns)
        config_redelocal_dns_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[7]/td[2]/input[1]').get_attribute('checked')
        ...
        config_redelocal_concessao = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[10]/td[1]').text
        print(config_redelocal_concessao)
        config_redelocal_concessao_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table[1]/tbody/tr[10]/td[2]/input').get_property('value')
        print(config_redelocal_concessao_valor)

        config_redelocal_tabela_concessao = self._driver.find_elements_by_id(
            'tblDhcpLease')
        ...
        config_wifi24.click()
        config_wifi24 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[3]/a').text
        config_wifi24_basico = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li[1]/a').text
        print(config_wifi24_basico)
        config_wifi24_basico_redeprivada = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[1]').text
        print(config_wifi24_basico_redeprivada)
        config_wifi24_basico_redeprivada_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[2]/input[1]').get_attribute('checked')
        ...
        if config_wifi24_basico_redeprivada_valor == 'true':
            ...
            config_wifi24_basico_habilitar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[2]/input[1]')
        ...
        config_wifi24_basico_anuncio = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[2]/td[1]').text
        print(config_wifi24_basico_anuncio)
        config_wifi24_basico_anuncio_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[2]/td[2]/input[1]').get_attribute('checked')
        ...
        config_wifi24_basico_ssid = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[3]/td[1]').text
        print(config_wifi24_basico_ssid)
        config_wifi24_basico_ssid_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[3]/td[2]/input').get_property('value')
        print(config_wifi24_basico_ssid_valor)

        config_wifi24_basico_ssid_senha = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[4]/td[1]').text
        print(config_wifi24_basico_ssid_senha)
        config_wifi24_basico_ssid_senha_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[4]/td[2]/input').get_property('value')
        print(config_wifi24_basico_ssid_senha_valor)
        config_wifi24_basico_seguranca = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[5]/td[1]').text
        print(config_wifi24_basico_seguranca)
        config_wifi24_basico_seguranca_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[5]/td[2]/select').get_property('value')
        ...
        config_wifi24_basico_wps = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[6]/td[1]').text
        print(config_wifi24_basico_wps)
        config_wifi24_basico_wps_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[6]/td[2]/input[1]').get_attribute('checked')
        ...
        config_wifi24_avancado = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li[2]/a')
        config_wifi24_avancado.click()
        time.sleep(1)
        config_wifi24_avancado = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li[2]/a').text
        print(config_wifi24_avancado)

        config_wifi24_avancado_modooperacao = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[1]/td[1]').text
        print(config_wifi24_avancado_modooperacao)
        config_wifi24_avancado_modooperacao_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[1]/td[2]/select').get_property('value')
        ...
        config_wifi24_avancado_canal = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[2]/td[1]').text
        print(config_wifi24_avancado_canal)
        config_wifi24_avancado_canal_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[2]/td[2]/select').get_property('value')
        ...
        config_wifi24_avancado_largurabanda_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[3]/td[2]/select').get_property('value')
        ...
        config_wifi24_avancado_wmm = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[5]/td[1]').text
        print(config_wifi24_avancado_wmm)
        config_wifi24_avancado_wmm_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[5]/td[2]/input[1]').get_attribute('checked')
        ...
        config_wifi24_avancado_mac = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[7]/td[1]').text
        print(config_wifi24_avancado_mac)
        config_wifi24_avancado_mac_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[7]/td[2]').text
        print(config_wifi24_avancado_mac_valor)

        if config_original_wifi24 == 1:
            config_wifi24_voltar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li[1]/a')
            config_wifi24_voltar.click()
            time.sleep(1)
            config_wifi24_basico_desabilitar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[2]/input[2]')
        ...
        config_wifi5.click()
        config_wifi5 = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[4]/a').text
        time.sleep(2)
        ...
        if config_wifi5_basico_redeprivada_valor == 'true':
            ...
            config_wifi5_basico_habilitar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[2]/input[1]')
        ...
        config_wifi5_basico_seguranca_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[5]/td[2]/select').get_property('value')
        ...
        config_wifi5_avancado_modooperacao_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[1]/td[2]/select').get_property('value')
        ...
        config_wifi5_avancado_canal_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[2]/td[2]/select').get_property('value')
        ...
        # selenium nao pega informacoes de texto de elementos ocultos
        config_wifi5_avancado_largurabanda = 'Largura de Banda do Canal:'
        print(config_wifi5_avancado_largurabanda)
        config_wifi5_avancado_largurabanda_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[4]/form/table/tbody/tr[3]/td[2]/select').get_property('value')
        ...
        if config_original_wifi5 == 1:
            config_wifi5_voltar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[2]/ul/li[1]/a')
            config_wifi5_voltar.click()
            time.sleep(1)
            config_wifi5_basico_desabilitar = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[1]/td[2]/input[2]')
        ...
        config_firewall_pingwan = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table[2]/thead[2]/tr/th').text
        print(config_firewall_pingwan)
        config_firewall_pingwan_status = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table[2]/tbody[2]/tr/td[1]').text
        print(config_firewall_pingwan_status)
        config_firewall_pingwan_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table[2]/tbody[2]/tr/td[2]/input[1]').get_attribute('checked')
        ...
        config_modowan = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[2]/ul/li[7]/a').text
        time.sleep(1)
        config_modowan_bridge = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/form/table/thead/tr/th').text
        print(config_modowan_bridge)

        config_modowan_bridge_modo = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/form/table/tbody/tr[1]/td[1]').text
        print(config_modowan_bridge_modo)
        config_modowan_bridge_modo_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/div[3]/form/table/tbody/tr[1]/td[2]/select').get_property('value')
        ...
        gerenciamento.click()
        gerenciamento = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[3]/a').text
        time.sleep(2)
        gerenciamento_idioma = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[3]/ul/li[1]/a')
        print(gerenciamento_idioma.text)
        gerenciamento_idioma.click()
        gerenciamento_idioma = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[1]/ul/li[3]/ul/li[1]/a').text
        time.sleep(2)
        gerenciamento_idioma = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/thead/tr/th').text
        print(gerenciamento_idioma)
        gerenciamento_idioma_valor = self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[2]/td/input[1]').get_attribute('checked')
    ...
    def checkWanInterface_x_427(self, flask_username, interface):
        ...
        try:
            ...
            wanInterface = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[2]/a').click()
            wanInterface = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[2]/a').text
            print(wanInterface)
            time.sleep(1)
            if interface == '1':
                # é necessario voltar um nivel na hierarquia para encontrar o elemento
                self._driver.switch_to.parent_frame()
                self._driver.switch_to.frame('mainFrm')
                index = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfList"]/table/tbody/tr[' + str(interface) + ']/td[2]/a').click()
                wanInterface_AdminState = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/div[1]/label').text
                print(wanInterface_AdminState)
                wanInterface_AdminState_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/div[1]/input[1]').get_attribute('checked')
                ...
                wanInterface_VLANPrior = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/legend').text
                print(wanInterface_VLANPrior)
                wanInterface_VLANPrior_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/div[1]/input[1]').get_attribute('checked')
                ...
                wanInterface_VLANPrior_VLANID = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/div[2]/label').text
                print(wanInterface_VLANPrior_VLANID)
                wanInterface_VLANPrior_VLANID_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/div[2]/input').get_attribute('value')
                print(wanInterface_VLANPrior_VLANID_valor)
                wanInterface_VLANPrior_priority = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/div[3]/label').text
                print(wanInterface_VLANPrior_priority)
                wanInterface_VLANPrior_priority_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[1]/div[3]/select').get_attribute('value')
                print(wanInterface_VLANPrior_priority_valor)

                wanInterface_Addressing = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[3]/legend').text
                print(wanInterface_Addressing)
                wanInterface_Addressing_type = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[2]/div/label').text
                ...
                wanInterface_Addressing_PPPoE = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/legend').text
                print(wanInterface_Addressing_PPPoE)
                wanInterface_Addressing_PPPoE_user = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[1]/label').text
                print(wanInterface_Addressing_PPPoE_user)
                wanInterface_Addressing_PPPoE_user_valor = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[1]/input').get_attribute('value')
                print(wanInterface_Addressing_PPPoE_user_valor)
                wanInterface_Addressing_PPPoE_passwd = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[2]/label').text
                print(wanInterface_Addressing_PPPoE_passwd)
                wanInterface_Addressing_PPPoE_passwd_valor = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[2]/input').get_attribute('value')
                print(wanInterface_Addressing_PPPoE_passwd_valor)
                wanInterface_Addressing_PPPoE_ServiceName = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[3]/label').text
                print(wanInterface_Addressing_PPPoE_ServiceName)
                wanInterface_Addressing_PPPoE_ServiceName_valor = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[3]/input').get_attribute('value')
                print(wanInterface_Addressing_PPPoE_ServiceName_valor)
                wanInterface_Addressing_PPPoE_ACName = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[4]/label').text
                print(wanInterface_Addressing_PPPoE_ACName)
                wanInterface_Addressing_PPPoE_ACName_valor = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[4]/input').get_attribute('value')
                print(wanInterface_Addressing_PPPoE_ACName_valor)
                wanInterface_Addressing_PPPoE_IdlTimeout = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[6]/label').text
                print(wanInterface_Addressing_PPPoE_IdlTimeout)
                wanInterface_Addressing_PPPoE_IdlTimeout_valor = self._driver.find_element_by_xpath(
                    '//*[@id="pppoe"]/div[6]/input').get_attribute('value')
                print(wanInterface_Addressing_PPPoE_IdlTimeout_valor)

                wanInterface_Addressing_DNS = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[2]/legend').text
                print(wanInterface_Addressing_DNS)
                wanInterface_Addressing_DNS_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[3]/div[1]/input').get_attribute('checked')
                ...
                wanInterface_Addressing_DNS_Primary = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[3]/div[2]/label').text
                ...
                wanInterface_Addressing_DNS_Secondary = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[3]/div[3]/label').text
                ...
                wanInterface_Addressing_IPv6 = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/legend').text
                print(wanInterface_Addressing_IPv6)
                wanInterface_Addressing_IPv6_AdmState = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/div[1]/label').text
                ...
                wanInterface_Addressing_IPv6_Unnumbered = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/div[2]/label').text
                print(wanInterface_Addressing_IPv6_Unnumbered)
                wanInterface_Addressing_IPv6_Unnumbered_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/div[2]/input[1]').get_attribute('checked')
                ...
                wanInterface_Addressing_IPv6_AddrType = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/div[3]/label').text
                print(wanInterface_Addressing_IPv6_AddrType)
                wanInterface_Addressing_IPv6_AddrType_valor = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[4]/div[3]/input[1]').get_attribute('checked')
                ...
                if json_saida427['IPv6'].get('Adm.State') == 'Dual Stack':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": "IPv6: Adm.State: Dual Stack", "result": "passed"})
                else:
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno {json_saida427['IPv6'].get('Adm.State')}"})

                self.update_global_result_memory(
                    flask_username, 'checkWanInterface_x_427', json_saida427)
                return self._dict_result
                ...
                if self._driver.find_element_by_xpath('//*[@id="WanIPIntfSettingForm"]/fieldset[2]/div/input[1]').get_attribute('checked') == 'true':
                    ...
                    wanInterface_Addressing_type_valor = 'Estático'
                print(wanInterface_Addressing_type_valor)
                wanInterface_Addressing_DHCPSet = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/legend').text
                print(wanInterface_Addressing_DHCPSet)
                wanInterface_Addressing_DHCPSet_VendorID = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[1]/label').text
                print(wanInterface_Addressing_DHCPSet_VendorID)
                wanInterface_Addressing_DHCPSet_VendorID_valor = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[1]/input').get_attribute('value')
                print(wanInterface_Addressing_DHCPSet_VendorID_valor)
                wanInterface_Addressing_DHCPSet_Client = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[2]/label').text
                print(wanInterface_Addressing_DHCPSet_Client)
                wanInterface_Addressing_DHCPSet_Client_valor = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[2]/input').get_attribute('value')
                print(wanInterface_Addressing_DHCPSet_Client_valor)
                wanInterface_Addressing_DHCPSet_UserClassID = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[3]/label').text
                print(wanInterface_Addressing_DHCPSet_UserClassID)
                wanInterface_Addressing_DHCPSet_UserClassID_valor = self._driver.find_element_by_xpath(
                    '//*[@id="ipoe"]/div[3]/input').get_attribute('value')
                print(wanInterface_Addressing_DHCPSet_UserClassID_valor)

                wanInterface_DNS = self._driver.find_element_by_xpath(
                    '//*[@id="WanIPIntfSettingForm"]/fieldset[3]/legend').text
                ...
                self._driver.quit()
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": json_saida427, "result": "passed"})
                self.update_global_result_memory(
                    flask_username, 'checkWanInterface_x_427', json_saida427)
                return self._dict_result
    ...
    def validarDHCPv6Wan_428(self, flask_username):
        ...
        if len(result) == 0:
            ...
            if 'SLAAC' == ans_428:
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": "Addressing Type igual a SLAAC", "result": "passed"})
            else:
                self._dict_result.update(
    ...
    def checkLANSettings_429(self, flask_username):
        ...
        try:
            ...
            ### ------------------------------------------ ###
            lanSettings = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/p[1]/b').text
            print(lanSettings)
            lanSettings_ipInterfc = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[1]').click()
            time.sleep(1)
            lanSettings_ipInterfc = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[1]').text
            print(lanSettings_ipInterfc)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            lanSettings_ipInterfc_ipv4 = self._driver.find_element_by_xpath(
                '/html/body/h1').text
            print(lanSettings_ipInterfc_ipv4)
            lanSettings_ipInterfc_ipv4_ipInterfc = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[1]/a').text
            print(lanSettings_ipInterfc_ipv4_ipInterfc)
            lanSettings_ipInterfc_ipv4_ipInterfc_adminState = self._driver.find_element_by_xpath(
                '/html/body/div/div/div[1]/form/div[1]/label').text
            print(lanSettings_ipInterfc_ipv4_ipInterfc_adminState)
            lanSettings_ipInterfc_ipv4_ipInterfc_adminState_valor = self._driver.find_element_by_xpath(
                '/html/body/div/div/div[1]/form/div[1]/input[1]').get_attribute('checked')
            ...
            lanSettings_ipInterfc_ipv4_ipInterfc_IGMPSnooping = self._driver.find_element_by_xpath(
                '/html/body/div/div/div[1]/form/div[2]/label').text
            print(lanSettings_ipInterfc_ipv4_ipInterfc_IGMPSnooping)
            lanSettings_ipInterfc_ipv4_ipInterfc_IGMPSnooping_valor = self._driver.find_element_by_xpath(
                '/html/body/div/div/div[1]/form/div[2]/input[1]').get_attribute('checked')
            ...
            lanSettings_ipInterfc_ipv4_ipv4_addr = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').click()
            lanSettings_ipInterfc_ipv4_ipv4_addr = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').text
            ...
            for head in range(1, len(self._driver.find_elements_by_xpath('//*[@id="Tab2_1"]/table/thead/tr/th'))):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="Tab2_1"]/table/thead/tr/th[' + str(head) + ']').text
                lanSettings_ipInterfc_ipv4_ipv4_addr_head.append(teste)
            print(lanSettings_ipInterfc_ipv4_ipv4_addr_head)
            countlinhas = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab2_1"]/table/tbody/tr'))
            countcols = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab2_1"]/table/tbody/tr[1]/td'))
            lanSettings_ipInterfc_ipv4_ipv4_addr_table = []
            print(teste)
            for col in range(1, countcols):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="Tab2_1"]/table/tbody/tr/td[' + str(col) + ']').text
            ...
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('menuFrm')
            lanSettings_ipv6 = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[3]').click()
            lanSettings_ipv6 = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[3]').text
            print(lanSettings_ipv6)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            lanSettings_ipv6_Status = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/div[1]/label[1]').text
            print(lanSettings_ipv6_Status)
            lanSettings_ipv6_Status_valor = self._driver.find_element_by_xpath(
                '//*[@id="ipv6_opr_status"]').text
            print(lanSettings_ipv6_Status_valor)
            lanSettings_ipv6_Global = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/div[2]/label[1]').text
            print(lanSettings_ipv6_Global)
            lanSettings_ipv6_Global_valor = self._driver.find_element_by_xpath(
                '//*[@id="g_ipv6addr_all"]').text
            print(lanSettings_ipv6_Global_valor)
            lanSettings_ipv6_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/div[3]/label').text
            print(lanSettings_ipv6_AdmState)
            lanSettings_ipv6_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/div[3]/input[1]').get_attribute('checked')
            ...
            lanSettings_ipv6_RADVD = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/legend').text
            print(lanSettings_ipv6_RADVD)
            lanSettings_ipv6_RADVD_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[1]/label').text
            print(lanSettings_ipv6_RADVD_AdmState)
            lanSettings_ipv6_RADVD_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[1]/input[1]').get_attribute('checked')
            ...
            lanSettings_ipv6_RADVD_PrfxDeleg = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[2]/label').text
            print(lanSettings_ipv6_RADVD_PrfxDeleg)
            lanSettings_ipv6_RADVD_PrfxDeleg_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPIntfId"]').get_attribute('value')
            ...
            lanSettings_ipv6_RADVD_PrfxDeleg_ULA_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[3]/input').get_attribute('checked')
            ...
            lanSettings_ipv6_RADVD_Prefix = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[4]/label').text
            print(lanSettings_ipv6_RADVD_Prefix)
            lanSettings_ipv6_RADVD_Prefix_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[4]/input').get_attribute('value')
            print(lanSettings_ipv6_RADVD_Prefix_valor)
            lanSettings_ipv6_RADVD_Preferred = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[5]/label').text
            print(lanSettings_ipv6_RADVD_Preferred)
            lanSettings_ipv6_RADVD_Preferred_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[5]/input').get_attribute('value')
            print(lanSettings_ipv6_RADVD_Preferred_valor)
            lanSettings_ipv6_RADVD_Valid = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[6]/label').text
            print(lanSettings_ipv6_RADVD_Valid)
            lanSettings_ipv6_RADVD_Valid_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[1]/div[6]/input').get_attribute('value')
            print(lanSettings_ipv6_RADVD_Valid_valor)

            lanSettings_ipv6_DHCPv6 = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/legend').text
            print(lanSettings_ipv6_DHCPv6)
            lanSettings_ipv6_DHCPv6_Mode = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[1]/label').text
            ...
            lanSettings_ipv6_DHCPv6_Start = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[2]/label').text
            print(lanSettings_ipv6_DHCPv6_Start)
            lanSettings_ipv6_DHCPv6_Start_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[2]/input').get_attribute('value')
            print(lanSettings_ipv6_DHCPv6_Start_valor)
            lanSettings_ipv6_DHCPv6_End = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[3]/label').text
            print(lanSettings_ipv6_DHCPv6_End)
            lanSettings_ipv6_DHCPv6_End_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[3]/input').get_attribute('value')
            print(lanSettings_ipv6_DHCPv6_End_valor)
            lanSettings_ipv6_DHCPv6_Lease = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[4]/label').text
            print(lanSettings_ipv6_DHCPv6_Lease)
            lanSettings_ipv6_DHCPv6_Lease_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPv6Form"]/fieldset[2]/div[4]/input').get_attribute('value')
                        ...
                        lanSettings_ipInterfc_ipv4_ipv4_addr:
                            {
                                ...
                                lanSettings_ipInterfc_ipv4_ipv4_addr_head[
                                    6]: lanSettings_ipInterfc_ipv4_ipv4_addr_table[6]
                            },
                        lanSettings_ipv6:
                            {
            ...
            for _, row in json_saida429.items():
                ...
                if prefix_wan == 'ip2':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": "Prefix Delegation WAN: ip2", "result": "passed"})
                    break
                else:
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno do Prefix Delegation WAN:{prefix_wan}"})

            self.update_global_result_memory(
                flask_username, 'checkLANSettings_429', json_saida429)
            return self._dict_result
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'PPPoe':
                        if sub_dict.get('VLAN') == '8,35':
                            self._dict_result.update(
                                {"obs": 'Type: PPPoE, VLAN: 8,35', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f"Teste incorreto, retorno Type: PPPoE | VLAN: {sub_dict.get('VLAN')}"})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno Type:{iface_type}"})
            else:
                self._dict_result.update(
            ...
            if cpe_config['REDE'] == 'VIVO_1' and cpe_config['ACCESS'] == 'FIBER' and cpe_config['TYPE'] == 'FIBER':
                for _, sub_dict in result.items():
                    ...
                    if iface_type == '8,35':
                        if sub_dict.get('Type') == 'PPPoE':
                            self._dict_result.update(
                                {"obs": 'VLAN: 8,35 | Type: PPPoE ', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f"Teste incorreto, retorno VLAN: 8,35 | Type: {sub_dict.get('TYPE')} "})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno VLAN:{iface_type}"})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
        return self._dict_result
    ...
    def vivo_1_ADSL_vlanIdPPPoE_433(self, flask_username):
        ...
        result = session.get_result_from_test(
            flask_username, 'checkNatSettings_423')
        if len(result) == 0:
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip2':
                        if sub_dict.get('Adm.State') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Interface: ip2 | Adm.State: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Interface: ip2 | Adm.State:{sub_dict.get("Adm.State")} '})
                            break
                else:
                    self._dict_result.update(
                        {"obs": 'Teste incorreto, retorno Interface:{iface_type}'})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
        ...
        if len(result) == 0:
            ...
            if cpe_config['REDE'] == 'VIVO_1' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
                ...
                if 'SLAAC' == ans_438:
                    ...
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno Addressing Type:{ans_438}"})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
        return self._dict_result
    ...
    def checkLANSettings_439(self, flask_username):
        ...
        result = session.get_result_from_test(
            flask_username, 'checkLANSettings_429')
        if len(result) == 0:
            self._dict_result.update({"obs": 'Execute o teste 429 primeiro'})
        else:
            cpe_config = config_collection.find_one()
            if cpe_config['REDE'] == 'VIVO_1' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
                ans_439 = result['LAN Setting']['IPv6']['RADVD'].get(
                    'Prefix Delegation WAN')
                if 'ip2' == ans_439:
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": "Prefix Delegation WAN: ip2", "result": "passed"})
                else:
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno Prefix Delegation WAN:{ans_439}"})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
        return self._dict_result
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'PPPoe':
                        if sub_dict.get('VLAN') == '0,35':
                            self._dict_result.update(
                                {"obs": 'Type: PPPoE | VLAN: 0,35', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Type: PPPoE | VLAN: {sub_dict.get("VLAN")}'})
            ...
            if cpe_config['REDE'] == 'VIVO_2' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip2':
                        if sub_dict.get('Adm.State') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Interfac: ip2 | Adm.State: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": 'Teste incorreto, retorno Interface: ip2 | Adm.State: Desabilitado'})
                            break
                    else:
                        self._dict_result.update(
    ...
    def vivo_2_passwordPppDefault_446(self, flask_username):
        ...
        if cpe_config['REDE'] == 'VIVO_2' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
            ...
            if senha == 'cliente@cliente':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'Senha: cliente@cliente', "result": "passed"})
            else:
                self._dict_result.update(
                    {"obs": f'Teste incorreto, retorno Senha: {senha}'})
        else:
        ...
        if len(result) == 0:
            ...
            if cpe_config['REDE'] == 'VIVO_2' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
                for idx, sub_dict in result.items():
                    ...
                    self._dict_result.update(
                        {"obs": f'Teste incorreto, retorno {idx}'})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
        return self._dict_result
        ...
        if len(result) == 0:
            ...
            if cpe_config['REDE'] == 'VIVO_2' and cpe_config['ACCESS'] == 'COOPER' and cpe_config['TYPE'] == 'ADSL':
                ...
                if 'SLAAC' == ans_448:
                    ...
                    self._dict_result.update(
                        {"obs": f"Testes incorreto, retorno Addressing Type: {ans_448}"})
            else:
                self._dict_result.update(
                    {"obs": f"REDE:{cpe_config['REDE']} | ACCESS:{cpe_config['ACCESS']} | TYPE:{cpe_config['TYPE']}"})
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip4':
                        if sub_dict.get('VLAN') == '20':
                            self._dict_result.update(
                                {"obs": 'Name: ip4 | VLAN: 20', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Name: ip4 | VLAN {sub_dict.get("VLAN")}'})
                            break
                    else:
                        self._dict_result.update(
                            {"obs":  f'Teste incorreto, retorno Name: {iface_type}'})
            else:
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip4':
                        if sub_dict.get('Priority') == '3':
                            self._dict_result.update(
                                {"obs": 'Name: ip4 | Priority: 3', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Name: ip4 | Priority: {sub_dict.get("Priority")}'})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Name: {iface_type}'})
            ...
            if cpe_config['REDE'] == 'VIVO_1':
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip4':
                        if sub_dict.get('Adm.State') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Interface: ip4 | Adm.State: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Interface: Ip4 | Adm.State: {sub_dict.get("Adm.State")} '})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Interface: {iface_type}'})
    ...
    def vivo_1_igmpIptv_453(self, flask_username):
        ...
        result = session.get_result_from_test(
            flask_username, 'checkMulticastSettings_424')
        if len(result) == 0:
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip2':
                        if sub_dict.get('IGMP') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Interface: ip2, IGMP: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Interface: ip2, IGMP: {sub_dict.get("IGMP")}'})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Interface: {iface_type}'})
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip5':
                        if sub_dict.get('VLAN') == '602':
                            self._dict_result.update(
                                {"obs": 'Name: ip5, VLAN: 602', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Name: ip5, VLAN: {sub_dict.get("VLAN")}'})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Name: {iface_type}'})
    ...
    def vivo2_validarNatIPTV_455(self, flask_username):
        ...
        try:
            result1 = session.get_result_from_test(
                flask_username, 'checkWanInterface_420')
            result2 = session.get_result_from_test(
                flask_username, 'checkNatSettings_423')

        except KeyError as exception:
            self._dict_result.update(
                {"obs": 'Execute o teste 420 e o teste 423 primeiro'})
            ...
            if cpe_config['REDE'] == 'VIVO_2':
                ...
                for _, sub_dict in result2.items():
                    ...
                    if iface_type == iface_name:
                        if sub_dict.get('Adm.State') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Adm.State:  Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Adm.State: {sub_dict.get("Adm.State")} '})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Name 1: {iface_type}, Name 2: {iface_name} '})
            ...
            if cpe_config['REDE'] == 'VIVO_2':
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip5':
                        if sub_dict.get('IGMP') == 'Habilitado':
                            self._dict_result.update(
                                {"obs": 'Interface: ip5 | IGMP: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Interface: ip5 | IGMP: {sub_dict.get("IGMP")}'})
                            break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Interface: {iface_type}'})
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip5':
                        if sub_dict.get('VLAN') == '4000':
                            self._dict_result.update(
                                {"obs": 'Name: ip5 | VLAN: 4000', "result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
                            self._dict_result.update(
                                {"obs": f'Teste incorreto, retorno Name: ip5 | VLAN: {sub_dict.get("VLAN")} '})
            ...
            for _, sub_dict in result.items():
                ...
                if iface_type == 'ip4':
                    if sub_dict.get('Adm.State') == 'Desabilitado':
                        self._dict_result.update(
                            {"obs": 'Interface: ip4 | Adm.State: Desabilitado', "result": 'passed', "Resultado_Probe": "OK"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Interface: ip4 | Adm.State: {sub_dict.get("Adm.State")} '})
        ...
        if len(result) == 0:
            ...
            for _, sub_dict in result.items():
                ...
                if iface_type == 'ip4':
                    if sub_dict.get('IGMP') == 'Habilitado':
                        self._dict_result.update(
                            {"obs": 'Interface: ip4 | IGMP: Habilitado', "result": 'passed', "Resultado_Probe": "OK"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f'Teste incorreto, retorno Interface == ip4 | IGMP: {sub_dict.get("IGMP")} '})
                        break
            else:
                self._dict_result.update(
                    {"obs":  f'Teste incorreto, retorno Interface: {iface_type}'})
    ...
    def vivo1_vlanIdVoip_460(self, flask_username):
        ...
        if len(result) == 0:
                ...
                for _, sub_dict in result.items():
                    ...
                    if iface_type == 'ip3':
                        if sub_dict.get('VLAN') == '30':
                            ...
                            self._dict_result.update(
                                {"result": 'passed', "Resultado_Probe": "OK"})
                            break
                        else:
            ...
            self._dict_result.update(
                {"obs": f"Teste 460_1: {obs_result}, Teste 460_2: {obs_result2}"})
                ...
                for _, sub_dict in result1.items():
                    ...
                    if iface_type == '5':
                        if sub_dict.get('VLAN') == '30':
                            ...
                            obs_result1 = (
                                f'Teste incorreto, retorno Priority == 5 | VLAN: {sub_dict.get("VLAN")}')
                            break
                    else:
                        obs_result1 = (
                            f'Teste incorreto, retorno Priority: {iface_type}')
    ...
    def checkLANDHCPSettings_x_464(self, flask_username, port='4'):
        ...
        try:
            ...
            lanSettings = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/p[1]/b').text
            print(lanSettings)
            lanSettings_dhcp = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[2]').click()
            time.sleep(1)
            lanSettings_dhcp = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[1]/a[2]').text
            print(lanSettings_dhcp)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            lanSettings_dhcpServer = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerList"]/legend').text
            print(lanSettings_dhcpServer)

            countHead = len(self._driver.find_elements_by_xpath(
                '//*[@id="DHCPServerList"]/table/thead/tr/th'))
            tableHead = []
            for col in range(2, countHead):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="DHCPServerList"]/table/thead/tr/th['+str(col)+']').text
                tableHead.append(teste)
            print(tableHead)
            countlinhas = len(self._driver.find_elements_by_xpath(
                '//*[@id="DHCPServerList"]/table/tbody/tr'))
            countcols = len(self._driver.find_elements_by_xpath(
                '//*[@id="DHCPServerList"]/table/tbody/tr[1]/td'))

            table = []
            for linha in range(1, countlinhas+1):
                for col in range(2, countcols):
                    teste = self._driver.find_element_by_xpath(
                        '//*[@id="DHCPServerList"]/table/tbody/tr['+str(linha)+']/td['+str(col)+']').text
                    table.append(teste)
            print(table)
            ...
            index1 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerList"]/table/tbody/tr['+str(porta)+']/td[2]/a').click()
            dhcpServerSett = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerShow"]/div/ul/li[1]/a').text
            print(dhcpServerSett)
            dhcpServerSett_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[1]/label').text
            print(dhcpServerSett_AdmState)
            dhcpServerSett_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[1]/input[1]').get_property('value')
            if dhcpServerSett_AdmState_valor == '1':
                dhcpServerSett_AdmState_valor = 'Habilitado'
            else:
                dhcpServerSett_AdmState_valor = 'Desabilitado'
            print(dhcpServerSett_AdmState_valor)
            dhcpServerSett_AssocIntfc = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[2]/label').text
            print(dhcpServerSett_AssocIntfc)
            dhcpServerSett_AssocIntfc_valor = self._driver.find_element_by_xpath(
                '//*[@id="IPIntfId"]/option').get_property('value')
            if dhcpServerSett_AssocIntfc_valor == '1':
                dhcpServerSett_AssocIntfc_valor = 'ip1'
            print(dhcpServerSett_AssocIntfc_valor)
            dhcpServerSett_Prior = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[3]/label').text
            print(dhcpServerSett_Prior)
            dhcpServerSett_Prior_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[3]/input').get_property('value')
            if dhcpServerSett_Prior_valor == '1':
                dhcpServerSett_Prior_valor = 'Highest'
            elif dhcpServerSett_Prior_valor == '2':
                dhcpServerSett_Prior_valor = 'Insert as Order'
            ...
            dhcpServerSett_ClientConf = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/legend').text
            dhcpServerSett_ClientConf_IPRange = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/label').text
            print(dhcpServerSett_ClientConf_IPRange)
            dhcpServerSett_ClientConf_IPRange_ini = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/input[1]').get_property('value') + '.' +
                                                     self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/input[2]').get_property('value') + '.' +
                                                     self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/input[3]').get_property('value') + '.' +
            ...
            dhcpServerSett_ClientConf_IPRange_fim = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/input[6]').get_property('value') + '.' +
                                                     ...
                                                     self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[1]/input[9]').get_property('value'))
            print(dhcpServerSett_ClientConf_IPRange_fim)
            dhcpServerSett_ClientConf_Mask = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[2]/label').text
            print(dhcpServerSett_ClientConf_Mask)
            dhcpServerSett_ClientConf_Mask_valor = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[2]/input[1]').get_property('value') + '.' +
                                                    self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[2]/input[2]').get_property('value') + '.' +
                                                    self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[2]/input[3]').get_property('value') + '.' +
                                                    self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[2]/input[4]').get_property('value'))
            print(dhcpServerSett_ClientConf_Mask_valor)
            dhcpServerSett_ClientConf_Gtw = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[3]/label').text
            print(dhcpServerSett_ClientConf_Gtw)
            dhcpServerSett_ClientConf_Gtw_valor = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[3]/input[1]').get_property('value') + '.' +
                                                   self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[3]/input[2]').get_property('value') + '.' +
                                                   self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[3]/input[3]').get_property('value') + '.' +
                                                   self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[3]/input[4]').get_property('value'))
            print(dhcpServerSett_ClientConf_Gtw_valor)
            dhcpServerSett_ClientConf_DNS = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/label').text
            print(dhcpServerSett_ClientConf_DNS)
            dhcpServerSett_ClientConf_DNS_ini = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/input[1]').get_property('value') + '.' +
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/input[2]').get_property('value') + '.' +
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/input[3]').get_property('value') + '.' +
            ...
            dhcpServerSett_ClientConf_DNS_fim = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/input[6]').get_property('value') + '.' +
                                                 ...
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[4]/input[9]').get_property('value'))
            print(dhcpServerSett_ClientConf_DNS_fim)
            dhcpServerSett_ClientConf_Lease = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[5]/label').text
            print(dhcpServerSett_ClientConf_Lease)
            dhcpServerSett_ClientConf_Lease_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[1]/div[5]/input[1]').get_property('value')
            print(dhcpServerSett_ClientConf_Lease_valor)

            dhcpServerSett_Pool = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/legend').text
            print(dhcpServerSett_Pool)
            dhcpServerSett_Pool_vendorID = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[1]/input[1]').get_attribute('checked')  # VendorID valor
            if dhcpServerSett_Pool_vendorID == 'true':
                dhcpServerSett_Pool_vendorID = 'Habilitado'
            else:
                dhcpServerSett_Pool_vendorID = 'Desabilitado'
            print(dhcpServerSett_Pool_vendorID)
            dhcpServerSett_Pool_vendorID_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[1]/input[2]').get_property('value')
            print(dhcpServerSett_Pool_vendorID_valor)
            dhcpServerSett_Pool_MatchRange = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[2]/span').text
            print(dhcpServerSett_Pool_MatchRange)
            dhcpServerSett_Pool_MatchRange_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[2]/input[1]').get_attribute('checked')
            if dhcpServerSett_Pool_MatchRange_valor == 'true':
                dhcpServerSett_Pool_MatchRange_valor = 'Include'
            else:
                dhcpServerSett_Pool_MatchRange_valor = 'Exclude'
            print(dhcpServerSett_Pool_MatchRange_valor)
            dhcpServerSett_Pool_MatchMode = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[3]/span').text
            print(dhcpServerSett_Pool_MatchMode)
            dhcpServerSett_Pool_MatchMode_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[3]/input[1]').get_property('value')
            if dhcpServerSett_Pool_MatchMode_valor == '0':
                dhcpServerSett_Pool_MatchMode_valor = 'Exato'
            elif dhcpServerSett_Pool_MatchMode_valor == '1':
                dhcpServerSett_Pool_MatchMode_valor = 'Prefixo'
                ...
                dhcpServerSett_Pool_MatchMode_valor = 'Substring'
            print(dhcpServerSett_Pool_MatchMode_valor)
            dhcpServerSett_Pool_clientID = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[4]/input[1]').get_attribute('checked')  # ClientID valor
            if dhcpServerSett_Pool_clientID == 'true':
                dhcpServerSett_Pool_clientID = 'Habilitado'
            else:
                dhcpServerSett_Pool_clientID = 'Desabilitado'
            print(dhcpServerSett_Pool_clientID)
            dhcpServerSett_Pool_clientID_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[4]/input[2]').get_property('value')
            print(dhcpServerSett_Pool_clientID_valor)
            dhcpServerSett_Pool_MatchRange2 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[5]/span').text
            print(dhcpServerSett_Pool_MatchRange2)
            dhcpServerSett_Pool_MatchRange_valor2 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[5]/input[1]').get_attribute('checked')
            if dhcpServerSett_Pool_MatchRange_valor2 == 'true':
                dhcpServerSett_Pool_MatchRange_valor2 = 'Include'
            else:
                dhcpServerSett_Pool_MatchRange_valor2 = 'Exclude'
            print(dhcpServerSett_Pool_MatchRange_valor2)
            dhcpServerSett_Pool_UserClassID = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[6]/input[1]').get_attribute('checked')  # UserClassID
            print(dhcpServerSett_Pool_UserClassID)
            if dhcpServerSett_Pool_UserClassID == 'true':
                dhcpServerSett_Pool_UserClassID = 'Habilitado'
            else:
                dhcpServerSett_Pool_UserClassID = 'Desabilitado'
            dhcpServerSett_Pool_UserClassID_valor = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[4]/input[2]').get_property('value')
            print(dhcpServerSett_Pool_UserClassID_valor)
            dhcpServerSett_Pool_MatchRange3 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[5]/span').text
            print(dhcpServerSett_Pool_MatchRange3)
            dhcpServerSett_Pool_MatchRange_valor3 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[7]/input[1]').get_attribute('checked')
            if dhcpServerSett_Pool_MatchRange_valor3 == 'true':
                dhcpServerSett_Pool_MatchRange_valor3 = 'Include'
            else:
                dhcpServerSett_Pool_MatchRange_valor3 = 'Exclude'
            print(dhcpServerSett_Pool_MatchRange_valor3)
            dhcpServerSett_Pool_MAC = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[8]/input').get_attribute('checked')  # MAC
            print(dhcpServerSett_Pool_MAC)
            if dhcpServerSett_Pool_MAC == 'true':
                dhcpServerSett_Pool_MAC = 'Habilitado'
            else:
                dhcpServerSett_Pool_MAC = 'Desabilitado'
            print(dhcpServerSett_Pool_MAC)
            dhcpServerSett_Pool_MACAddr = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[9]/label').text
            print(dhcpServerSett_Pool_MACAddr)
            dhcpServerSett_Pool_MACAddr_valor = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[9]/input[1]').get_property('value') + ':' +
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[9]/input[2]').get_property('value') + ':' +
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[9]/input[3]').get_property('value') + ':' +
                                                 ...
                                                 self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[9]/input[6]').get_property('value'))
            print(dhcpServerSett_Pool_MACAddr_valor)
            dhcpServerSett_Pool_Mask = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[10]/label').text
            print(dhcpServerSett_Pool_Mask)
            dhcpServerSett_Pool_Mask_valor = (self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[10]/input[1]').get_property('value') + ':' +
                                              self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[10]/input[2]').get_property('value') + ':' +
                                              self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[10]/input[3]').get_property('value') + ':' +
                                              ...
                                              self._driver.find_element_by_xpath('//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[10]/input[6]').get_property('value'))
            print(dhcpServerSett_Pool_Mask_valor)
            dhcpServerSett_Pool_MatchRange4 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[11]/span').text
            print(dhcpServerSett_Pool_MatchRange4)
            dhcpServerSett_Pool_MatchRange_valor4 = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerSettingForm"]/div[4]/fieldset[2]/div[11]/input[1]').get_attribute('checked')
            if dhcpServerSett_Pool_MatchRange_valor4 == 'true':
                dhcpServerSett_Pool_MatchRange_valor4 = 'Include'
            else:
                dhcpServerSett_Pool_MatchRange_valor4 = 'Exclude'
            ...
            options = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerShow"]/div/ul/li[4]/a').click()
            options = self._driver.find_element_by_xpath(
                '//*[@id="DHCPServerShow"]/div/ul/li[4]/a').text
            print(options)
            countHeadOptions = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab4_1"]/table/thead/tr/th'))
            tableHeadoptions = []
            for col in range(2, countHeadOptions+1):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="Tab4_1"]/table/thead/tr/th[' + str(col) + ']').text
                tableHeadoptions.append(teste)
            print(tableHeadoptions)
            countlinhas = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab4_1"]/table/tbody/tr'))
            countcols = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab4_1"]/table/tbody/tr[1]/td'))

            tableOptions = []
            for linha in range(1, countlinhas + 1):
                for col in range(2, countcols+1):
                    teste = self._driver.find_element_by_xpath(
                        '//*[@id="Tab4_1"]/table/tbody/tr[' + str(linha) + ']/td[' + str(col) + ']').text
                    tableOptions.append(teste)
            print(tableOptions)
            ...
            if porta == '1':
                ...
                if json_saida464['LAN DHCP']['Index #3']['Detalhes']['DHCP Server Setting']['Client Configuration'].get('Gateway') == '192.168.16.1':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": json_saida464, "result": "passed"})
                else:
                    self._dict_result.update({"obs": json_saida464})

                self.update_global_result_memory(
                    flask_username, 'checkLANDHCPSettings_x_464', json_saida464)
                return self._dict_result
                ...
                gateway = json_saida464['LAN DHCP']['Index #3']['Detalhes']['DHCP Server Setting']['Client Configuration'].get(
                    'Gateway')
                if gateway == '192.168.16.1':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": f"Gateway: 192.168.16.1", "result": "passed"})
                else:
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno Gateway: {gateway}"})
    ...
    def poolDhcpLan_465(self, flask_username):
        ...
        if len(result) == 0:
            ...
            start_addr = result['LAN DHCP']['Index #3']['Detalhes']['DHCP Server Setting']['Client Configuration']['IP Address Range'].get(
                'inicio')
            end_addr = result['LAN DHCP']['Index #3']['Detalhes']['DHCP Server Setting']['Client Configuration']['IP Address Range'].get(
                'fim')
    ...
    def leaseTime_466(self, flask_username):
        ...
        if len(result) == 0:
            ...
            ans_466 = result['LAN DHCP']['Index #3']['Detalhes']['DHCP Server Setting']['Client Configuration'].get(
                'Lease Time (seconds)')
            if '14400' == ans_466:
                self._dict_result.update(
                    {"obs": 'Lease Time: 14400', "result": 'passed', "Resultado_Probe": "OK"})
            else:
                self._dict_result.update(
    ...
    def vendorIdIptvEnable_467(self, flask_username):
        ...
        self._driver.switch_to.frame('mainFrm')
        self._driver.find_element_by_xpath(
            '/html/body/fieldset[1]/table/tbody/tr[2]/td[2]/a').click()
        time.sleep(1)

        vendorID = self._driver.find_element_by_xpath(
            '/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[2]/div[1]').text
        vendorID_check = self._driver.find_element_by_xpath(
            '/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[2]/div[1]/input[1]').get_attribute('checked')
        if vendorID_check:
            vendorID_check = 'Habilitado'
        else:
            vendorID_check = 'Desabilitado'
        print(vendorID+': '+vendorID_check)
        vendorValue = self._driver.find_element_by_xpath(
            '/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[2]/div[1]/input[2]').get_attribute('value')
        print(vendorValue)
        ...
        ipRangeInicioValue = self._driver.find_element_by_xpath('/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[1]/div[1]/input[1]').get_attribute('value')+'.' +\
            ...
            self._driver.find_element_by_xpath(
                '/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[1]/div[1]/input[4]').get_attribute('value')
        ...
        ipRangeFimValue = self._driver.find_element_by_xpath('/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[1]/div[1]/input[6]').get_attribute('value')+'.' +\
            ...
            self._driver.find_element_by_xpath(
                '/html/body/fieldset[2]/div/div/div[1]/form/div[4]/fieldset[1]/div[1]/input[9]').get_attribute('value')
        ...
        self._dict_result.update(
            {"obs": f"467_1: {obs_result1} | 467_2: {obs_result2} | 467_3: {obs_result3}"})
    ...
    def poolDhcpIptv_468(self, flask_username):
        ...
        result = session.get_result_from_test(
            flask_username, 'vendorIdIptvEnable_467')
        if len(result) == 0:
            self._dict_result.update({"obs": 'Execute o teste 467 primeiro'})
        else:
            ip_inicio = result['LAN DHCP']['Index 1']['Detalhes']['DHCP Server Setting']['Client Configuration']['IP Address Range'].get(
                'inicio')
            ip_fim = result['LAN DHCP']['Index 1']['Detalhes']['DHCP Server Setting']['Client Configuration']['IP Address Range'].get(
                'fim')
    ...
    def verificarWifi24SsidDefault_470(self, flask_username):
        ...
        if len(result) == 0:
            ...
            result_ssid = result['Configurações']['Rede Wifi 2.4Ghz']['Básico'].get(
                'SSID:')
    ...
    def verificarWifi24Habilitado_471(self, flask_username):
        ...
        if len(result) == 0:
            ...
            rede_pv = result['Configurações']['Rede Wifi 2.4Ghz']['Básico'].get(
                'Rede Wi-Fi Privada:')
    ...
    def verificarWifi24Padrao_472(self, flask_username):
        ...
        if len(result) == 0:
            ...
            modo_ope = result['Configurações']['Rede Wifi 2.4Ghz']['Avançado'].get(
                'Modo de Operação:')
    ...
    def frequencyPlan_473(self, flask_username):
        ...
        self._driver.switch_to.frame('menuFrm')
        self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/fieldset/div[4]/a[1]').click()
        time.sleep(1)
        self._driver.switch_to.parent_frame()
        self._driver.switch_to.frame('mainFrm')
        bandwidth24G = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[4]/fieldset/div[3]/label').text
        bandwidth24G_value = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[4]/fieldset/div[3]/select').get_attribute('value')
        ...
        channel24G = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[4]/fieldset/div[5]/label').text
        channel24G_values = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[4]/fieldset/div[5]/select')
        channel24G_list = [x.get_attribute(
            'value') for x in channel24G_values.find_elements_by_tag_name("option")]
        ...
        if bandwidth24G_value == '20MHz':
            ...
            if channel24G_list == ref_list:
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'check List Channels: OK', "result": "passed"})
            else:
                self._dict_result.update(
                    {"obs": 'Teste incorreto, retorno check List Channels: NOK'})
    ...
    def verificarWifi24AutoChannel_474(self, flask_username):
        ...
        if len(result) == 0:
            ...
            canal = result['Configurações']['Rede Wifi 2.4Ghz']['Avançado'].get(
                'Canal:')
            if canal == '0':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'Canal: 0', "result": "passed"})
            else:
                self._dict_result.update(
    ...
    def verificarWifi24LarguraBanda_475(self, flask_username):
        ...
        if len(result) == 0:
            ...
            larg_banda_canal = result['Configurações']['Rede Wifi 2.4Ghz']['Avançado'].get(
    ...
    def verificarWifi24Seguranca_476(self, flask_username):
        ...
        if len(result) == 0:
            ...
            seguranca = result['Configurações']['Rede Wifi 2.4Ghz']['Básico'].get(
                'Modo de Segurança:')
            if seguranca == 'WPA2':
                self._dict_result.update(
    ...
    def verificarWifi24PasswordDefault_477(self, flask_username):
        ...
        self._driver.switch_to.frame('menuFrm')
        self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/fieldset/div[4]/a[2]').click()
        time.sleep(1)
        self._driver.switch_to.parent_frame()
        self._driver.switch_to.frame('mainFrm')
        ...
        time.sleep(1)
        self._driver.find_element_by_xpath(
            '/html/body/div/div/div[2]/div[1]/table/tbody/tr[1]/td[1]/a').click()

        passphrase_value = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[4]/div[1]/input').get_attribute('value')
        ...
        if password:
            self._dict_result.update(
                {"Resultado_Probe": "OK", "obs": 'Passprhase: OK', "result": "passed"})
        else:
            self._dict_result.update(
                {"obs": 'Teste incorreto, retorno Passphrase: NOK'})
    ...
    def cipherModeDefault_478(self, flask_username):
        ...
        encryption = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[2]/label').text
        encryption_value = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[2]/select').get_attribute('value')
        if encryption_value == '4':
            encryption_value = "AES"
        print(encryption, "=", encryption_value)

        if encryption_value == "AES":
            self._dict_result.update(
                {"Resultado_Probe": "OK", "obs": 'Encryption: AES', "result": "passed"})
        else:
            self._dict_result.update(
    ...
    def verificarWifi24WPS_479(self, flask_username):
        ...
        if len(result) == 0:
            ...
            wps = result['Configurações']['Rede Wifi 2.4Ghz']['Básico'].get(
                'WPS:')
            if wps == 'Habilitado':
                self._dict_result.update(
...
#### 5GHz ####
    def verificarWifi5SsidDefault_480(self, flask_username):
        ...
        if len(result) == 0:
            ...
            result_ssid = result['Configurações']['Rede Wifi 5Ghz']['Básico'].get(
                'SSID:')
    ...
    def verificarWifi5Habilitado_481(self, flask_username):
        ...
        if len(result) == 0:
            ...
            rede_pv = result['Configurações']['Rede Wifi 5Ghz']['Básico'].get(
                'Rede Wi-Fi Privada:')
            if rede_pv == 'Habilitado':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'Rede Wi-Fi Privada: Habilitado', "result": "passed"})
    ...
    def verificarWifi5Padrao_482(self, flask_username):
        ...
        if len(result) == 0:
            ...
            modo_ope = result['Configurações']['Rede Wifi 5Ghz']['Avançado'].get(
                'Modo de Operação:')
    ...
    def frequencyPlan5GHz_483(self, flask_username):
        ...
        self._driver.switch_to.parent_frame()
        self._driver.switch_to.frame('mainFrm')
        bandwidth5G = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[5]/fieldset/div[3]/label').text
        bandwidth5G_value = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[5]/fieldset/div[3]/select').get_attribute('value')
        ...
        channel5G = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[5]/fieldset/div[4]/label[1]').text
        channel5G_values = self._driver.find_element_by_xpath(
            '/html/body/div/div/div[1]/form/div[5]/fieldset/div[4]/select')
        channel5G_list = [x.get_attribute(
            'value') for x in channel5G_values.find_elements_by_tag_name("option")]
    ...
    def verificarWifi5AutoChannel_484(self, flask_username):
        ...
        if len(result) == 0:
            ...
            canal = result['Configurações']['Rede Wifi 5Ghz']['Avançado'].get(
                'Canal:')
            if canal == '0':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'Canal: 0', "result": "passed"})
    ...
    def verificarWifi5LarguraBanda_485(self, flask_username):
        ...
        if len(result) == 0:
            ...
            larg_banda_canal = result['Configurações']['Rede Wifi 5Ghz']['Avançado'].get(
                'Largura de Banda do Canal:')
    ...
    def verificarWifi5Seguranca_486(self, flask_username):
        ...
        if len(result) == 0:
            ...
            seguranca = result['Configurações']['Rede Wifi 5Ghz']['Básico'].get(
                'Modo de Segurança:')
            if seguranca == 'WPA2':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'Modo de Segurança: WPA2', "result": "passed"})
    ...
    def verificarWifi5PasswordDefault_487(self, flask_username):
        ...
        if len(result) == 0:
            ...
            result_senha = result['Configurações']['Rede Wifi 5Ghz']['Básico'].get(
                'Senha:')
    ...
    def verificarWifi5WPS_489(self, flask_username):
        ...
        if len(result) == 0:
            ...
            wps = result['Configurações']['Rede Wifi 5Ghz']['Básico'].get(
                'WPS:')
            if wps == 'Habilitado':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": 'WPS: Habilitado', "result": "passed"})
    ...
    def checkVoIPSettings_490(self, flask_username):
        ...
        try:
            ...
            time.sleep(3)
            self._driver.switch_to.frame('menuFrm')
            voiceBasic = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[7]/a[1]').click()
            voiceBasic = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[7]/a[1]').text
            print(voiceBasic)
            time.sleep(1)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            voiceBasic_SipService = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[1]/a').text
            print(voiceBasic_SipService)
            voiceBasic_SipService_ActOutProxy = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/div[1]/label[1]').text
            print(voiceBasic_SipService_ActOutProxy)
            voiceBasic_SipService_ActOutProxy_valor = self._driver.find_element_by_xpath(
                '//*[@id="opr_outbound_proxy"]').get_attribute('value')
            print(voiceBasic_SipService_ActOutProxy_valor)
            voiceBasic_SipService_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/div[2]/label').text
            print(voiceBasic_SipService_AdmState)
            voiceBasic_SipService_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/div[2]/input[2]').get_attribute('checked')
            ...
            voiceBasic_SipService_BoundInterface = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/div[1]/label[1]').text
            print(voiceBasic_SipService_BoundInterface)
            voiceBasic_SipService_BoundInterface_valor = self._driver.find_element_by_xpath(
                '//*[@id="opr_outbound_proxy"]').get_attribute('value')
            print(voiceBasic_SipService_BoundInterface_valor)

            voiceBasic_SipService_SipNet = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/legend').text
            print(voiceBasic_SipService_SipNet)
            voiceBasic_SipService_SipNet_UsrAgtDomain = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/label[1]').text
            print(voiceBasic_SipService_SipNet_UsrAgtDomain)
            voiceBasic_SipService_SipNet_UsrAgtDomain_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/input[1]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_UsrAgtDomain_valor)
            voiceBasic_SipService_SipNet_UsrAgtDomain_port = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/label[2]').text
            print(voiceBasic_SipService_SipNet_UsrAgtDomain_port)
            voiceBasic_SipService_SipNet_UsrAgtDomain_port_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/input[2]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_UsrAgtDomain_port_valor)
            voiceBasic_SipService_SipNet_UsrAgtDomain_Transp = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/label[3]').text
            print(voiceBasic_SipService_SipNet_UsrAgtDomain_Transp)
            voiceBasic_SipService_SipNet_UsrAgtDomain_Transp_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[1]/select').get_attribute('value')
            print(voiceBasic_SipService_SipNet_UsrAgtDomain_Transp_valor)

            voiceBasic_SipService_SipNet_OutProxy = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[2]/label[1]').text
            print(voiceBasic_SipService_SipNet_OutProxy)
            voiceBasic_SipService_SipNet_OutProxy_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[2]/input[1]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_OutProxy_valor)
            voiceBasic_SipService_SipNet_OutProxy_port = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[2]/label[2]').text
            print(voiceBasic_SipService_SipNet_OutProxy_port)
            voiceBasic_SipService_SipNet_OutProxy_port_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[2]/input[2]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_OutProxy_port_valor)

            voiceBasic_SipService_SipNet_RegServer = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/label[1]').text
            print(voiceBasic_SipService_SipNet_RegServer)
            voiceBasic_SipService_SipNet_RegServer_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/input[1]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_RegServer_valor)
            voiceBasic_SipService_SipNet_RegServer_port = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/label[2]').text
            print(voiceBasic_SipService_SipNet_RegServer_port)
            voiceBasic_SipService_SipNet_RegServer_port_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/input[2]').get_attribute('value')
            print(voiceBasic_SipService_SipNet_RegServer_port_valor)
            voiceBasic_SipService_SipNet_RegServer_Transp = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/label[3]').text
            print(voiceBasic_SipService_SipNet_RegServer_Transp)
            voiceBasic_SipService_SipNet_RegServer_Transp_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[1]/div[4]/select').get_attribute('value')
            print(voiceBasic_SipService_SipNet_RegServer_Transp_valor)

            voiceBasic_SipService_SipNet_ConfCallURL = self._driver.find_element_by_xpath(
                '//*[@id="conference"]/label').text
            print(voiceBasic_SipService_SipNet_ConfCallURL)
            voiceBasic_SipService_SipNet_ConfCallURL_valor = self._driver.find_element_by_xpath(
                '//*[@id="conference"]/input').get_attribute('value')
            print(voiceBasic_SipService_SipNet_ConfCallURL_valor)

            voiceBasic_SipService_SipBasicSettings = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/legend').text
            print(voiceBasic_SipService_SipBasicSettings)
            voiceBasic_SipService_SipBasicSettings_DigiMap = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[1]/label').text
            print(voiceBasic_SipService_SipBasicSettings_DigiMap)
            voiceBasic_SipService_SipBasicSettings_DigiMap_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[1]/textarea').get_attribute('value')
            print(voiceBasic_SipService_SipBasicSettings_DigiMap_valor)
            voiceBasic_SipService_SipBasicSettings_DTMFMeth = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[2]/label').text
            print(voiceBasic_SipService_SipBasicSettings_DTMFMeth)
            voiceBasic_SipService_SipBasicSettings_DTMFMeth_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[2]/select').get_attribute('value')
            ...
            voiceBasic_SipService_SipBasicSettings_Hook = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[3]/label').text
            print(voiceBasic_SipService_SipBasicSettings_Hook)
            voiceBasic_SipService_SipBasicSettings_Hook_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[3]/select').get_attribute('value')
            print(voiceBasic_SipService_SipBasicSettings_Hook_valor)
            voiceBasic_SipService_SipBasicSettings_Fax = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[4]/label').text
            print(voiceBasic_SipService_SipBasicSettings_Fax)
            voiceBasic_SipService_SipBasicSettings_Fax_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicSipServiceForm"]/fieldset[2]/div[4]/input[1]').get_attribute('checked')
            ...
            voiceBasic_LineSettings = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').click()
            time.sleep(1)
            voiceBasic_LineSettings = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').text
            print(voiceBasic_LineSettings)
            headcol = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab2_1"]/table/thead/tr/th'))
            header = []
            for head in range(2, headcol+1):
                ...
                header.append(teste)
            print(header)
            count_linhas = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab2_1"]/table/tbody/tr'))
            count_cols = len(self._driver.find_elements_by_xpath(
                '//*[@id="Tab2_1"]/table/tbody/tr/td'))
            voiceBasic_LineSettings_table = []
            for l in range(1, count_linhas+1):
                for c in range(2, count_cols+1):
                    teste = self._driver.find_element_by_xpath(
                        '//*[@id="Tab2_1"]/table/tbody/tr[' + str(l) + ']/td[' + str(c) + ']').text
                    voiceBasic_LineSettings_table.append(teste)
            print(voiceBasic_LineSettings_table)
            voiceBasic_LineSettings_accessIndex = self._driver.find_element_by_xpath(
                '//*[@id="Tab2_1"]/table/tbody/tr/td[1]/a').click()
            time.sleep(1)
            voiceBasic_LineSettings_accessIndex_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/div/label').text
            print(voiceBasic_LineSettings_accessIndex_AdmState)
            voiceBasic_LineSettings_accessIndex_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/div/input[1]').get_attribute('checked')
            ...
            voiceBasic_LineSettings_accessIndex_SIPClient = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[1]/legend').text
            print(voiceBasic_LineSettings_accessIndex_SIPClient)
            voiceBasic_LineSettings_accessIndex_SIPClient_URI = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[1]/div[1]/label').text
            print(voiceBasic_LineSettings_accessIndex_SIPClient_URI)
            voiceBasic_LineSettings_accessIndex_SIPClient_URI_valor = self._driver.find_element_by_xpath(
                '//*[@id="register_uri"]').get_attribute('value')
            print(voiceBasic_LineSettings_accessIndex_SIPClient_URI_valor)
            voiceBasic_LineSettings_accessIndex_SIPClient_AuthUser = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[1]/div[2]/label').text
            print(voiceBasic_LineSettings_accessIndex_SIPClient_AuthUser)
            voiceBasic_LineSettings_accessIndex_SIPClient_AuthUser_valor = self._driver.find_element_by_xpath(
                '//*[@id="auth_username"]').get_attribute('value')
            print(voiceBasic_LineSettings_accessIndex_SIPClient_AuthUser_valor)
            voiceBasic_LineSettings_accessIndex_SIPClient_AuthPass = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[1]/div[3]/label').text
            print(voiceBasic_LineSettings_accessIndex_SIPClient_AuthPass)
            voiceBasic_LineSettings_accessIndex_SIPClient_AuthPass_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[1]/div[3]/input').get_attribute('value')
            print(voiceBasic_LineSettings_accessIndex_SIPClient_AuthPass_valor)
            voiceBasic_LineSettings_accessIndex_CODEC = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[2]/legend').text
            print(voiceBasic_LineSettings_accessIndex_CODEC)
            voiceBasic_LineSettings_accessIndex_CODEC_VAD = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[2]/div/label').text
            print(voiceBasic_LineSettings_accessIndex_CODEC_VAD)
            voiceBasic_LineSettings_accessIndex_CODEC_VAD_valor = self._driver.find_element_by_xpath(
                '//*[@id="BasicLineSettingForm"]/fieldset/fieldset[2]/div/input[1]').get_attribute('checked')
            ...
            codec_head = self._driver.find_element_by_xpath(
                '//*[@id="codec"]/thead/tr/th[1]').text
            print(codec_head)
            count_linhas = len(self._driver.find_elements_by_xpath(
                '//*[@id="codec"]/tbody/tr'))
            codec_table = []
            for linha in range(1, count_linhas + 1):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="codec"]/tbody/tr[' + str(linha) + ']/td[1]').text
                codec_table.append(teste)
            print(codec_table)
            order_head = self._driver.find_element_by_xpath(
                '//*[@id="codec"]/thead/tr/th[2]').text
            print(order_head)
            order_table = []
            for linha in range(1, count_linhas + 1):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="codec"]/tbody/tr[' + str(linha) + ']/td[2]/select').get_attribute('value')
                order_table.append(teste)
            print(order_table)
            admState_head = self._driver.find_element_by_xpath(
                '//*[@id="codec"]/thead/tr/th[3]').text
            print(admState_head)
            admState_table = []
            for linha in range(1, count_linhas + 1):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="codec"]/tbody/tr[' + str(linha) + ']/td[3]/input').get_attribute('checked')
                admState_table.append(teste)
            print(admState_table)
            ptime_head = self._driver.find_element_by_xpath(
                '//*[@id="codec"]/thead/tr/th[4]').text
            print(ptime_head)
            ptime_table = []
            for linha in range(1, count_linhas + 1):
                teste = self._driver.find_element_by_xpath(
                    '//*[@id="codec"]/tbody/tr[' + str(linha) + ']/td[4]/select').get_attribute('value')
                if teste == '2':
                    teste = '10'
                elif teste == '4':
                    teste = '20'
            ...
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('menuFrm')
            voiceAdvc = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[7]/a[2]').click()
            time.sleep(1)
            voiceAdvc = self._driver.find_element_by_xpath(
                '/html/body/div[2]/div/fieldset/div[7]/a[2]').text
            print(voiceAdvc)
            # é necessario voltar um nivel na hierarquia para encontrar o elemento
            self._driver.switch_to.parent_frame()
            self._driver.switch_to.frame('mainFrm')
            voiceAdvc_SipServ = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[1]/a').text
            ...
            voiceAdvc_SipServ = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[1]/a').text
            print(voiceAdvc_SipServ)
            voiceAdvc_SipServ_AdmState = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/div[1]/label').text
            print(voiceAdvc_SipServ_AdmState)
            voiceAdvc_SipServ_AdmState_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/div[1]/input[1]').get_attribute('checked')
            ...
            voiceAdvc_SipServ_region = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/div[2]/label').text
            print(voiceAdvc_SipServ_region)
            voiceAdvc_SipServ_region_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/div[2]/input').get_attribute('value')
            print(voiceAdvc_SipServ_region_valor)
            voiceAdvc_SipServ_SIPAdv = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/legend').text
            print(voiceAdvc_SipServ_SIPAdv)
            voiceAdvc_SipServ_SIPAdv_RegPeri = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[1]/label').text
            print(voiceAdvc_SipServ_SIPAdv_RegPeri)
            voiceAdvc_SipServ_SIPAdv_RegPeri_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[1]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_RegPeri_valor)
            voiceAdvc_SipServ_SIPAdv_RegRetry = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[2]/label').text
            print(voiceAdvc_SipServ_SIPAdv_RegRetry)
            voiceAdvc_SipServ_SIPAdv_RegRetry_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[2]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_RegRetry_valor)
            voiceAdvc_SipServ_SIPAdv_RegExpi = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[3]/label').text
            print(voiceAdvc_SipServ_SIPAdv_RegExpi)
            voiceAdvc_SipServ_SIPAdv_RegExpi_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[3]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_RegExpi_valor)
            voiceAdvc_SipServ_SIPAdv_SessionExpi = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[4]/label').text
            print(voiceAdvc_SipServ_SIPAdv_SessionExpi)
            voiceAdvc_SipServ_SIPAdv_SessionExpi_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[4]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_SessionExpi_valor)
            voiceAdvc_SipServ_SIPAdv_MinSession = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[5]/label').text
            print(voiceAdvc_SipServ_SIPAdv_MinSession)
            voiceAdvc_SipServ_SIPAdv_MinSession_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[5]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_MinSession_valor)
            voiceAdvc_SipServ_SIPAdv_DSCPSIP = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[6]/label').text
            print(voiceAdvc_SipServ_SIPAdv_DSCPSIP)
            voiceAdvc_SipServ_SIPAdv_DSCPSIP_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[6]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_DSCPSIP_valor)
            voiceAdvc_SipServ_SIPAdv_DSCPRTP = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[7]/label').text
            print(voiceAdvc_SipServ_SIPAdv_DSCPRTP)
            voiceAdvc_SipServ_SIPAdv_DSCPRTP_valor = self._driver.find_element_by_xpath(
                '//*[@id="AdvanceSipServiceForm"]/fieldset/div[7]/input').get_attribute('value')
            print(voiceAdvc_SipServ_SIPAdv_DSCPRTP_valor)

            voiceAdvc_Line = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').click()
            time.sleep(1)
            voiceAdvc_Line = self._driver.find_element_by_xpath(
                '/html/body/div/ul/li[2]/a').text
            ...
            self._dict_result.update(
                {"obs": f"490_1: {obs_result1} | 490_2: {obs_result2}"})
    ...
    def verificarDtmfMethod_491(self, flask_username):
        ...
        result = session.get_result_from_test(
            flask_username, 'checkVoIPSettings_490')
        if len(result) == 0:
            ...
            for idx, sub_dict in basic_setting.items():
                if idx == 'DTMF Method':
                    if sub_dict == 'RFC2833':
                        self._dict_result.update(
                            {"Resultado_Probe": "OK", "obs": "DTMF Method: RFC2833", "result": "passed"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno DTMF Method: {sub_dict}"})
                        break
                else:
        ...
        if len(result) == 0:
            ...
            for keys in list_codec:
                ...
                if prior_codec == '0':
                    if keys == 'G.711ALaw':
                        self._dict_result.update(
                            {"Resultado_Probe": "OK", "obs": "Order: 0 = G.711ALaw", "result": "passed"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno Order: 0 = {keys} "})
                        break
                else:
                    self._dict_result.update(
        ...
        if len(result) == 0:
            ...
            for keys in list_codec:
                ...
                if prior_codec == '1':
                    if keys == 'G.729':
                        self._dict_result.update(
                            {"Resultado_Probe": "OK", "obs": "Order: 1 = G.729", "result": "passed"})
                        break
                    else:
                        self._dict_result.update(
                            {"obs": f"Teste incorreto, retorno Order: 1 = {keys} "})
                        break
                else:
                    self._dict_result.update(
                        {"obs": f"Teste incorreto, retorno Order: {prior_codec}"})
    ...
    def checkNATALGSettings_495(self, flask_username):
        ...
        self._driver.switch_to.frame('menuFrm')
        self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/fieldset/div[3]/div[3]/a[3]').click()
        time.sleep(1)
        self._driver.switch_to.parent_frame()
        self._driver.switch_to.frame('mainFrm')
        sip = self._driver.find_element_by_xpath(
            '/html/body/div/fieldset/form/input[4]').get_attribute('value')
        time.sleep(1)
        self._driver.quit()
        ...
        if rede == 'VIVO_1':
            if sip == 'Desabilitado':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": f'SIP: Desabilitado (Rede = {rede})', "result": "passed"})
            else:
                self._dict_result.update(
                    {"obs": f'Teste incorreto, retorno SIP: {sip} (Rede = {rede})'})
            return self._dict_result

        elif rede == 'VIVO_2':
            if sip == 'Habilitado':
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": f'SIP == Habilitado (Rede = {rede})', "result": "passed"})
            else:
                self._dict_result.update(
                    {"obs": f'Teste incorreto, retorno SIP: {sip} (Rede = {rede})'})
            return self._dict_result
    ...
    def checkUPnP_497(self, flask_username):
        ...
        self._driver.switch_to.frame('menuFrm')
        self._driver.find_element_by_xpath(
            '/html/body/div[2]/div/fieldset/div[8]/a').click()
        time.sleep(1)
        self._driver.switch_to.parent_frame()
        self._driver.switch_to.frame('mainFrm')
        upnp = self._driver.find_element_by_xpath(
            '/html/body/div/fieldset/form/div[1]/input[1]').get_attribute('value')
        ...
        if upnp == 'Habilitado':
            self._dict_result.update(
                {"Resultado_Probe": "OK", "obs": 'UPnP: Habilitado', "result": "passed"})
        else:
            self._dict_result.update(
                {"obs": f'Teste incorreto, retorno UPnP: {upnp}'})
    ...
    def linkLocalType_498(self, flask_username):
        ...
        if len(result) == 0:
            ...
            linkLocal = result['Status']['Internet']['IPv6']['Endereço IPv6 Link-Local - LAN:'].split('/')[
                1]
            if linkLocal == '64':
                self._dict_result.update(
        ...
        if len(result) == 0:
            ...
            try:
                if linkGlobal.split('/')[1] == '64':
                    self._dict_result.update(
                        {"Resultado_Probe": "OK", "obs": "LAN global identifier: 64", "result": "passed"})
            except:
                self._dict_result.update(
    ...
    def prefixDelegationfromInet_500(self, flask_username):
        ...
        if len(result) == 0:
            ...
            ans_500 = result['LAN Setting']['IPv6']['RADVD'].get(
                'Prefix Delegation WAN')
            if 'ip2' == ans_500:
                self._dict_result.update(
                    {"Resultado_Probe": "OK", "obs": "Prefix Delegation WAN: ip2", "result": "passed"})
                ...
                self._dict_result.update(
                    {"obs": f"Teste incorreto, retorno Prefix Delegation WAN: {ans_500}"})
        return self._dict_result
