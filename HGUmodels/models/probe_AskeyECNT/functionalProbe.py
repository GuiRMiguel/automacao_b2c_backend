...
class HGU_AskeyECNT_functionalProbe(HGU_AskeyECNT):
    ...
    def checkSpeed5GHz_19(self, flask_username):
        ...
        try:
            ...
            pass_5g = self._driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[2]/div[3]/table/tbody/tr[4]/td[2]/input')
    ...
    def uninterruptedPing_23(self, flask_username):
        ...
        try:
            ...
            self._driver.get('http://' + self._address_ip + '/')
            self._driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[2]/td[2]/input').click()
            time.sleep(1)
            self._driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[2]/table/tbody/tr[3]/td[2]/input').click()
            time.sleep(1)
            user_input = self._driver.find_element_by_id('txtUser')
            user_input.send_keys(self._username)
            pass_input = self._driver.find_element_by_id('txtPass')
    ...
    def testStreaming_25(self, flask_username) -> dict:
        ...
        """
        timePlaying = 15
        wifiSSID = "VIVO automacao Askey ECNT"
    ...
    def validiteSerialNumberAndMac_50(self, flask_username):
        try:
            ...
            time.sleep(3)
            try:
                if self._driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[2]/table[1]/tbody/tr[3]/td[2]').text == 'F45420941B71' and self._driver.find_element_by_xpath('/html/body/div[2]/div/div[1]/div[2]/table[1]/tbody/tr[4]/td[2]').text == '7C:DB:98:41:80:E1':
    ...
    def performWiFiSetup_46(self, flask_username):
        ...
        try:
            ...
            # 1) 2.4/5GHz SSID cannot be set to "¨"
            input_ssid_2g = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/div[3]/input')
            input_ssid_2g.clear()
            input_ssid_2g.send_keys('VIVO 2GHz ¨')
            time.sleep(1)
            ...
            # 4) 2.4/5 GHz password cannot be set to "¨"
            input_pass_2g = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[4]/div[1]/input')
            input_pass_2g.clear()
            input_pass_2g.send_keys("123456789abcde¨")
            time.sleep(1)
            self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/div[6]/input[5]').click()
            ...
            self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[1]/table/tbody/tr[1]/td[1]/a').click()
            time.sleep(1)
            ssid_adv_5g_input = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/div[3]/input')
            ...
            # 1) 2.4/5GHz SSID cannot be set to "¨"
            input_ssid_5g = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/div[3]/input')
            input_ssid_5g.clear()
            ...
            # Performing changes on password
            pass_adv_5g_input = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[4]/div[1]/input')
            ...
            # 4) 2.4/5 GHz password cannot be set to "¨"
            input_pass_5g = self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/fieldset[1]/div/div[4]/div[1]/input')
            input_pass_5g.clear()
            input_pass_5g.send_keys("123456789abcde¨")
            time.sleep(1)
            self._driver.find_element_by_xpath('/html/body/div/div/div[2]/div[2]/form/div[6]/input[5]').click()
